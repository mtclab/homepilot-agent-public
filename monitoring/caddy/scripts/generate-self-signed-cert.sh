...
DOMAIN="${1:-homepilot.example.com}"
ALT_NAMES="${DOMAIN}"
ALT_NAMES+=",zabbix.${DOMAIN}"
ALT_NAMES+=",n8n.${DOMAIN}"
ALT_NAMES+=",localhost"
ALT_NAMES+=",homepilot.example.com"
...
echo "  2. Edit Caddyfile — replace homepilot.example.com with your domain"
